...
var MeetupDetail_module = __webpack_require__(780);
...
async function getStaticPaths() {
    const client = await external_mongodb_.MongoClient.connect("mongodb+srv://forxynet:1m6tgooXjTyxgwdA@cluster0.w33vq.mongodb.net/meetup");
    const db = client.db();
